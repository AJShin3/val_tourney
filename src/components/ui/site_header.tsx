  ...
  return (
    <div className="flex flex-col gap-y-4 max-w-lg md:max-w-xl">
      ...
      <p className="text-val-white/70 text-sm">
        ...
        X/Twitter. all team blocks are clickable and will provide a number of
        team stats. additionally, all player images are clickable and summarize
        a players stats from the 2025 Franchise Season.
      </p>
      <p className="text-val-white/70 text-sm">
